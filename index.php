...
<body>
    ...
    <div class="auth-cover-form">
        <form action="/brief/processing/authentification.php" method="post"></form>

        <h1 class="text-center">Se connecter</h1>

        <p>Renseignez vos paramètres de connexion dans les champs pour vous connecter à votre compte.</p>
        ...
        <input type="email" placeholder="Saisir l'e-mail ici ..." id="email" name="email" required minlength="6" maxlength="50">
        <br><br>
